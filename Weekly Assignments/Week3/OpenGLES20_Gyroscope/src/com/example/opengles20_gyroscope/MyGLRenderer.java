...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 unused) {
    	...
    	float[] orient = MainActivity.gyro;
    	float[] delta = MainActivity.accel;
    	float[] rift = MainActivity.magnet;
    	boolean gryo = MainActivity.gyroExists;
       ...
       // Matrix.multiplyMM(scratch, 0, mMVPMatrix, 0, MainActivity.deltaRotationMatrix, 0);
        // Draw square
        //mImg.draw(scratch);
        // Draw triangle
        mCube.draw(scratch);
